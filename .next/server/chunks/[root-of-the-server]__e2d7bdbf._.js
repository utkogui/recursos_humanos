...
async function POST(request) {
    try {
        ...
        const existingColaborador = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].colaborador.findUnique({
            where: {
                cpf: body.cpf
            }
        });
        ...
        const existingEmail = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].colaborador.findUnique({
            where: {
                email: body.email
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2d7bdbf._.js.map